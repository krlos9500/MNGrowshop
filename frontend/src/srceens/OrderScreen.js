      ...
      <div class="order">
        <div class="order-info">
          <div>
            ...
            ${
              isDelivered
                ? `<div class="success">Enviado a ${deliveredAt}</div>`
                : `<div class="error">Sin enviar</div>`
            }
          ...
          <div>
            ...
            ${
              isPaid
                ? `<div class="success">Pago de ${paidAt}</div>`
                : `<div class="error">Sin Pagar</div>`
            }
          </div>
          <div>
        ...
        <div class="order-action">
           <ul>
                <li>
                 ...
                 <li><div>Articulos</div><div>$${itemsPrice}</div></li>
                 <li><div>Envio</div><div>$${shippingPrice}</div></li>
                 <li><div>Iva</div><div>$${taxPrice}</div></li>
